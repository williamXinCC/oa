...
public class DoGenerator {
    ...
    protected String packageBase     = "com.pointlion.sys.mvc.admin.oa.apply";
    // 生成类路径
    protected String srcFolder       = "/src/main/java/";
    // 生成资源路径
    protected String sourceFolder    = "/src/main/webapp";
    // 前端统一路径
    protected String pageFolder      = "/WEB-INF/admin/oa/";
    //生成model的时候去掉的表名前缀
    protected String modelPrefixes   = "";
    //生成model的时候去掉的ClassName前缀
    protected String packagePrefixes = "Oa";
    //工作空间路径
    protected final static String workSpacePath = PropKit.get("workSpacePath");
    ...
    /**
     * 生成Controller   C:/Users/xinchuang/Desktop/oa/JFinalOA-V2/JFinalOA/src/main/java/com/pointlion/sys/mvc/admin/uploadfile/OaUploadFileController.java
     * @param tableName         表名称
     */
...
//        generator.setModelTemplate(workSpacePath +"/" + PathKit.getPackagePath(mappingKitBulid)+"/template/java/model.html");
		// 生成
		generator.generate();
    }
