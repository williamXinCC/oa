...
import com.pointlion.sys.mvc.admin.oa.apply.uploadfile.OaUploadFileController;
...
public class OARoutes extends Routes{
	...
	public void config() {
		...
		// 稿件审核
		add("/admin/oa/apply/uploadfile", OaUploadFileController.class,"/apply/uploadfile");
		// ****
		...
		//流程在线编辑器和流程跟踪所用路由
		add("/processEditor/admin/oa/process-instance/highlights",ProcessInstanceHighlightsResource.class);//modeler
		add("/processEditor/admin/oa/process-instance/diagram-layout",ProcessInstanceDiagramLayoutResource.class);//modeler
		add("/processEditor/admin/oa/process-definition/diagram-layout",ProcessDefinitionDiagramLayoutResource.class);//modeler
//		add("/admin/oa/modelEditor/save",ModelSaveRestResource.class);
		add("/processEditor/admin/oa/modelEditor/save",ModelSaveRestResource.class);
		add("/processEditor/admin/oa/modelEditor/json",ModelEditorJsonRestResource.class);
		add("/processEditor/admin/oa/editor/stencilset",StencilsetRestResource.class);
	}
